        ...
        <div className='flex items-center gap-4 whitespace-nowrap'>
          ...
          <div className='bg-white shadow-lg rounded-xl p-3'>
            <a target='_blank' href="https://www.amazon.in/Kitchen-Dining-Summit-Home/s?rh=n%3A5925789031%2Cp_89%3ASummit" >
              <img src="/asset/images/Available/amazon.webp" alt="" className='w-16 h-16 object-contain' />
            </a>
          </div>
          <div className='bg-white shadow-lg rounded-xl p-3'>
            <a target='_blank' href="https://www.flipkart.com/kitchen-cookware-serveware/summit~brand/pr?sid=all%2Cupp" >
              <img src="/asset/images/Available/Flipkart.webp" alt="" className='w-16 h-16 object-contain' />
            </a>
          </div>
          <div className='bg-white shadow-lg rounded-xl p-3'>
            <a target='_blank' href="https://www.myntra.com/summit-pressure-cooker" >
              <img src="/asset/images/Available/Myntra.webp" alt="" className='w-16 h-16 object-contain' />
            </a>
          </div>
        </div>
        <div className='flex-grow h-[0.2rem] bg-gray-300 max-w-[350px]'></div>
      ...
      <div className='md:hidden flex flex-col items-center gap-4 w-full'>
        ...
        <div className='flex items-center justify-center gap-6'>
          <div className='bg-white shadow-lg rounded-xl p-2'>
            <a target='_blank' href="https://www.amazon.in/Kitchen-Dining-Summit-Home/s?rh=n%3A5925789031%2Cp_89%3ASummit" >
              <img src="/asset/images/Available/amazon.webp" alt="" className='size-10 object-contain' />
            </a>
          </div>
          <div className='bg-white shadow-lg rounded-xl p-2'>
            <a target='_blank' href="https://www.flipkart.com/kitchen-cookware-serveware/summit~brand/pr?sid=all%2Cupp" >
              <img src="/asset/images/Available/Flipkart.webp" alt="" className='size-10 object-contain' />
            </a>
          </div>
          <div className='bg-white shadow-lg rounded-xl p-2'>
            <a target='_blank' href="https://www.myntra.com/summit-pressure-cooker" >
              <img src="/asset/images/Available/Myntra.webp" alt="" className='size-10 object-contain' />
            </a>
          </div>
        </div>
      </div>
