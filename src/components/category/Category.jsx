                    ...
                    <div className="flex gap-2">
                        ...
                        <div className="w-1/5">
                            <Link to={`/category/pressure-cooker`}>
                                <div className="m-1 rounded-xl overflow-hidden">
                                    <img src={imageURL + "assets/category/pressure-cooker.webp"} />
                                </div>
                        ...
                        <div className="w-1/5">
                            <Link to={`/category/cookware`}>
                                <div className="m-1 rounded-xl overflow-hidden">
                                    <img src={imageURL + "assets/category/cookware.webp"} />
                                </div>
                        ...
                        <div className="w-1/5">
                            <Link to={`/category/gas-stove`}>
                                <div className="m-1 rounded-xl overflow-hidden">
                                    <img src={imageURL + "assets/category/gas-stove.webp"} />
                                </div>
                        ...
                        <div className="w-1/5">
                            <Link to={`/category/mixer-grinder`}>
                                <div className="m-1 rounded-xl overflow-hidden">
                                    <img src={imageURL + "assets/category/mixer-grinder.webp"} />
                                </div>
                        ...
                        <div className="w-1/5">
                            <Link to={`/category/gas-tandoor`}>
                                <div className="m-1 rounded-xl overflow-hidden">
                                    <img src={imageURL + "assets/category/gas-tandoor.webp"} />
                                </div>
