           ...
           <div class="section-menu-left">
               <div class="box-logo">
                   <a href="{{url('admin/dashboard')}}" id="site-logo-inner">
                       <img class="" id="logo_header" alt="" src="{{url('public/admin/assets')}}/images/logo/logo.png" data-light="{{url('public/admin/assets')}}/images/logo/logo.png" data-dark="{{url('public/admin/assets')}}/images/logo/logo-dark.png">
                   </a>
